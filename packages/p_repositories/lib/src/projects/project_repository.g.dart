...
class _ProjectsRepository implements ProjectsRepository {
  _ProjectsRepository(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ProjectModel> createProject(
    ...
    _data.addAll(createProjectRequest.toJson());
  ...
  Future<MessageResponse> editProject({
    ...
    final _options = _setStreamType<MessageResponse>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/projects/editProject/${projectId}/workspace/${workspaceId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
